# Temporarily commented out builder (using locally built dist/ folder instead)
...
# if using builder, then switch which line is active here:
COPY dist /var/www/korp-frontend
